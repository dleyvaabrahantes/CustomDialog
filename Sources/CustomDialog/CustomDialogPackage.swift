...
public struct CustomDialogPackage {
    public static func customDialog(nameImage: String, nameColor: Color, title: String, subtitle: String, actionNo: @escaping () -> Void, actionYes: @escaping () -> Void )-> some View {
